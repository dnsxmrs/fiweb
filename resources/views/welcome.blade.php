  ...
  <div class="flex items-center justify-center h-full">
    <div class="bg-white w-[1440px] h-[1024px] rounded-xl flex relative overflow-hidden">
      ...
      <div class="flex flex-col w-1/2 p-20 space-y-12">
        ...
        <div>
          ...
          <div class="flex space-x-8">
            <button class="flex flex-col items-center w-40 space-y-2 text-center">
              <img class="p-4 bg-gray-100 rounded-full w-28 h-28" src="{{ asset('assets/Food Bar.png') }}" alt="All">
              <p class="text-xl">All</p>
            </button>
            <button class="flex flex-col items-center w-40 space-y-2 text-center">
              <img class="p-4 bg-gray-100 rounded-full w-28 h-28" src="{{ asset('assets/Coffee Beans.png') }}" alt="Coffee">
              <p class="text-xl">Coffee</p>
            </button>
            <button class="flex flex-col items-center w-40 space-y-2 text-center">
              <img class="p-4 bg-gray-100 rounded-full w-28 h-28" src="{{ asset('assets/Iced Coffee.png') }}" alt="Non-Coffee">
              <p class="text-xl">Non-Coffee</p>
            </button>
            <button class="flex flex-col items-center w-40 space-y-2 text-center">
              <img class="p-4 bg-gray-100 rounded-full w-28 h-28" src="{{ asset('assets/Rice Bowl.png') }}" alt="Meal">
              <p class="text-xl">Meal</p>
            </button>
            <button class="flex flex-col items-center w-40 space-y-2 text-center">
              <img class="p-4 bg-gray-100 rounded-full h-28 w-28" src="{{ asset('assets/French Fries.png') }}" alt="Snack">
              <p class="text-xl">Snack</p>
            </button>
            <button class="flex flex-col items-center w-40 space-y-2 text-center">
              <img class="p-4 bg-gray-100 rounded-full w-28 h-28" src="{{ asset('assets/Cupcake.png') }}" alt="Dessert">
        ...
        <!-- Order Now Button -->
        <button class="absolute px-12 py-4 text-xl font-semibold text-center text-white bg-black rounded-lg w-60 bottom-20 left-20">
          Order Now
        </button>
      </div>
      ...
      <!-- Right Section with Background Image -->
        <div class="relative flex items-center justify-center w-1/2 overflow-hidden">
            ...
            <div class="relative z-10 flex space-x-8 w-[800px] h-[750px]">
              <!-- Coffee Image -->
              <img src="{{ asset('assets/Coffees.png') }}" alt="Coffee Image 1" class="object-cover w-full h-full">
          </div>          
              <div>
                <button class="absolute z-20 flex items-center justify-center w-40 px-6 py-3 text-lg text-white bg-black rounded-full top-10 right-10">
